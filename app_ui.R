...
page_one <- tabPanel(
  ...
  titlePanel("Exploring CO2 emissions over time for different countries"),
  ...
  This can be seen from my first varible, which organized data from  The Global
  ...
  After analyzing the historic role countries have contributed to climate
  ...
  My third variable focuses on how the amount of greenhouse gases emitted by the 
  ...
  Next, I decided to analyze each countries average greenhouse gases emission in
  ...
  Finally, as a citizen of the United States, I wanted to see how each producer 
